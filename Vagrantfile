...
"exercise" => {
"web_nodes" => {
  "web1" => { :ip => '192.168.56.10', :port => "28080" },
  }
  }
}
...
"exercise" => {
"app_nodes" => {
  "app1" => { :ip => '192.168.56.11', :port => "8484" },
  "app2" => { :ip => '192.168.56.12', :port => "8484" }
  }
  }
}
...
Vagrant.configure("2") do |config|
  ...
  app_nodes['exercise']['app_nodes'].each do |name, vals|
  ...
  balancer_nodes['exercise']['web_nodes'].each do |name, vals|
